...
const Departments = () => {
  ...
  // Department name mapping (you can expand this)
  const getDepartmentName = (code) => {
    const names = {
      ...
      'BK': 'Business Marketing',
      'BL': 'Business Law',
      'BR': 'Business Real Estate',
      'BY': 'Biology',
      'CE': 'Chemistry',
      'CJ': 'Criminal Justice',
      'CO': 'Communication',
      ...
      'FF': 'Foreign Language: French',
      'FG': 'Foreign Language: German',
      'FL': 'Foreign Language: Latin',
  ...
  // Get a color for each department
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Browse courses by department ({departments.length} departments)
          </p>
        </div>
          ...
          <div className="max-w-md">
            ...
            <div className="relative">
              <input
                ...
                placeholder="Search by department code (e.g., CS, MA, EN)"
        ...
        {filteredDepartments.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredDepartments.map((dept, index) => {
              ...
              const courseCount = typeof dept === 'object' ? dept.course_count : null;
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="mt-1 text-sm text-blue-700">
                  Click on any department card to view all courses offered in that department. 
                  You can filter courses by status, instructor, and more on the department page.
                </p>
              </div>
            </div>
          </div>
