...
const fetchStudents = async () => {
  ...
  try {
    ...
    const response = await fetch(`http://localhost:3000/api/v1/students?${queryParams}`);
                    ...
                    {students.length === 0 ? (
                      ...
                      students.map((student) => (
                        ...
                        >
                          ...
                          <td className="px-6 py-4 text-sm text-gray-900">
                            {Array.isArray(student.advisors)
                              ? student.advisors.map(a => a.name).join(', ')
                              : student.advisors || 'N/A'
                            }
                          </td>
